...
const Node = ({row,col,isStart,isEnd, isObstacle, onNodeClick}) =>{ // the row and col props are received from higher up
    ...
    return <div className={`node ${startClassName} ${EndClassName} ${ObsClassName}`} onClick={()=> onNodeClick(row,col)}></div> // a node simply shows as a 20/20 block
